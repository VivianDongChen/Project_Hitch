...
import com.heima.storage.service.AuthenticationAPIService;
import com.heima.storage.service.VehicleAPIService;
...
public class AccountHandler {
    ...
    public ResponseVO<VehicleVO> vehicleAuth() {
        ...
        VehiclePO vehiclePO = getVehiclePO(accountPO);
        try {
            //TODO:【allinone】任务2.1-车辆信息验证入口-2day
